        ...
        <div class="col-12">
            ...
            @endif
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            <div class="form-group row">
                                <label for="name" class="col-4 col-form-label text-md-right">{{ __('Team Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="aliases" class="col-4 col-form-label text-md-right">{{ __('Aliases') }}</label>
                    ...
                    <tw-form>
                        ...
                        <div class="counter">
                            <div class="form-group row">
                                <label for="counters" class="col-4 col-form-label text-md-right">{{ __('Team') }}</label>
                            ...
                            <div class="form-group row border-bottom">
                                <label for="counters" class="col-4 col-form-label text-md-right">{{ __('Notes') }}</label>
                    ...
                    <div class="card-body">
                        <div class="form-group row mb-0">
                            <div class="row justify-content-center col-12 spacing">
