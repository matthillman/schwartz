        ...
        <div class="col-12">
            <div class="card">
                ...
                <tw-plan
                    ...
                    :members="{{ $plan->guild->members->map(function($m) use ($unitIDs) { return $m->characterSet($unitIDs)->put('dm_status', $m->roles->dm_status); })->sortBy('sort_name', SORT_NATURAL|SORT_FLAG_CASE)->values()->toJson() }}"
