...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__chunk_2a882949_js__ = __webpack_require__(35);
...
var isValid = function (elm) {
    if (elm.nodeType === 1) {
        ...
        for (var i = 0; i < elm.attributes.length; i++) {
            ...
            if (Object(__WEBPACK_IMPORTED_MODULE_1__chunk_2a882949_js__["d" /* i */])(val) && val.toLowerCase().indexOf('on') === 0) {
                return false;
            }
        }
...
var Icon = /** @class */ (function () {
    ...
    Icon.prototype.loadIcon = function () {
        var _this = this;
        if (this.isVisible) {
            var url = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_2a882949_js__["c" /* g */])(this);
            if (url) {
                getSvgContent(url)
        ...
        if (!this.ariaLabel) {
            var label = Object(__WEBPACK_IMPORTED_MODULE_1__chunk_2a882949_js__["b"])(this.name, this.icon, this.mode, this.ios, this.md);
    ...
    Icon.prototype.render = function () {
        ...
        return (Object(__WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__["e" /* h */])(__WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__["a" /* H */], { role: "img", class: Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses(this.color), (_b = {}, _b["icon-" + this.size] = !!this.size, _b['flip-rtl'] = !!flipRtl && this.el.ownerDocument.dir === 'rtl', _b)) }, ((this.svgContent)
            ? Object(__WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__["e" /* h */])("div", { class: "icon-inner", innerHTML: this.svgContent })
            : Object(__WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__["e" /* h */])("div", { class: "icon-inner" }))));
    };
    ...
    Object.defineProperty(Icon.prototype, "el", {
        get: function () { return Object(__WEBPACK_IMPORTED_MODULE_0__chunk_58252182_js__["c" /* d */])(this); },
        enumerable: true,
        configurable: true
    });
